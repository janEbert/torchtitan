...
sys.path.insert('..')
from train import _get_batch, _batch_backward
...
class TestGradientAccumulation:
    ...
    def test_gradient_accumulation(self):
        ...
        assert torch.close(total_norm_original, total_norm_refactored), \
            "total norm does not match"
        assert torch.close(global_avg_loss_original, global_avg_loss_refactored), \
            "global avg loss does not match"
        assert torch.close(global_max_loss_original, global_max_loss_refactored), \
