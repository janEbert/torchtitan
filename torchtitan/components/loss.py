...
from torchtitan.models.llama.model import MTPInputsDict, TransformerInputsDict


def cross_entropy_loss(
        pred: Union[torch.Tensor, list[torch.Tensor], TransformerInputsDict],
        labels: torch.Tensor,
) -> torch.Tensor:
...
def multi_token_cross_entropy_loss(
        preds: Union[list[torch.Tensor], MTPInputsDict],
        labels: torch.Tensor,
        loss_fn: Callable,
