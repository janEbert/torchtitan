...
class DistributedScion(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        print(
            ...
            f" is enabled with world_mesh={world_mesh} | fsdp_enabled={self.fsdp_enabled} | expert_enabled={self.expert_enabled}"
        )
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group["params"]:
                ...
                norm_factor, backend = (
                    param_kwargs["norm_factor"],
                    param_kwargs["zeropower_backend"],
                )
