...
import math
from typing import Callable, ClassVar, NotRequired, Optional, Tuple, TypedDict, Union
...
TransformerInputs = Union[torch.Tensor, TransformerInputsDict]
...
MTPInputs = Union[torch.Tensor, MTPInputsDict]
