...
class _TransformerInputs(TypedDict):
    tokens_list: Union[list[Optional[torch.Tensor]], torch.Tensor]


TransformerInputs = Union[torch.Tensor, _TransformerInputs]


class _MTPInputs(_TransformerInputs):
    orig_tokens: NotRequired[Optional[torch.Tensor]]
    prev_embed: NotRequired[Optional[torch.Tensor]]


MTPInputs = Union[torch.Tensor, _MTPInputs]
...
class Transformer(nn.Module, ModelProtocol):
    ...
    def forward(self, inputs: MTPInputs) -> MTPInputs:
        """
        Perform a forward pass through the Transformer model.
        ...
        Returns:
            MTPInputs: Dictionary containing the following keys and values:
